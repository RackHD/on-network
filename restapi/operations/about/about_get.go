...
func NewAboutGet(ctx *middleware.Context, handler AboutGetHandler) *AboutGet {
	return &AboutGet{Context: ctx, Handler: handler}
}

/*AboutGet swagger:route GET /about /about aboutGet
...
type AboutGet struct {
	...
	Handler AboutGetHandler
}

func (o *AboutGet) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	route, rCtx, _ := o.Context.RouteInfo(r)
	if rCtx != nil {
		r = rCtx
	}
	var Params = NewAboutGetParams()
