...
type UpdateSwitchHandlerFunc func(UpdateSwitchParams) middleware.Responder

// Handle executing the request and returning a response
func (fn UpdateSwitchHandlerFunc) Handle(params UpdateSwitchParams) middleware.Responder {
	return fn(params)
}

// UpdateSwitchHandler interface for that can handle valid update switch params
type UpdateSwitchHandler interface {
	Handle(UpdateSwitchParams) middleware.Responder
}
