...
// NewSwitchFirmwareParams creates a new SwitchFirmwareParams object
// with the default values initialized.
func NewSwitchFirmwareParams() SwitchFirmwareParams {
	var ()
	return SwitchFirmwareParams{}
}

// SwitchFirmwareParams contains all the bound params for the switch firmware operation
// typically these are obtained from a http.Request
//
// swagger:parameters switchFirmware
type SwitchFirmwareParams struct {
