...
import (
	...
	opAPI "github.com/RackHD/on-network/restapi/operations/api"
...
func configureAPI(api *operations.OnNetworkAPI) http.Handler {
	...
	api.APIAboutGetHandler = opAPI.AboutGetHandlerFunc(func(params opAPI.AboutGetParams, principal interface{}) middleware.Responder {
